...
public class ArvoreBinaria{ 
   ...
   public int depth(No v){ 
    ...
    public No insertLeft(No v, Object o){ 
        
        if(v == null){ 
            throw new IllegalArgumentException("nó nulo");
        }
        if(v.getFilhoEsquerdo() != null){ 
            throw new IllegalStateException("Já tem filho esquerdo");
        }
        
        tamanho++;
        No no_atual = new No(v, o);
        v.setFilhoEsquerdo(no_atual);
        return no_atual;
    }
    
    public No insertRight(No v, Object o){ 
        
        if(v == null){ 
            throw new IllegalArgumentException("Nó nulo");
        }
        if(v.getFilhoDireito() != null){ 
            throw new IllegalStateException("Já tem filho direito");
        }
        
        tamanho++;
        No no_atual = new No(v, o);
        v.setFilhoDireito(no_atual);
